...
```sh
npm install paymasterfactorynew
```
## Table of contents

- [paymasterfactorynew](#paymasterfactorynew)
  - [Install](#install)
...
Contract schemas live in `./contracts`. Look inside of `scripts/codegen.js` and configure the settings for bundling your SDK and contracts into `paymasterfactorynew`:
